...
class HomePage extends StatefulWidget {
  const HomePage({super.key, required List<Map<String, dynamic>> tweets});
              ...
              children: [
                ListTile(
                  ...
                  title: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(tweet['username'], style: TextStyle(color: Colors.white)),
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text("${tweet['comments'].length}", style: TextStyle(color: Colors.white)),
                        ],
                      ),
                      Row(
                        children: [
